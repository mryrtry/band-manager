...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, CardModule, InputTextModule, InputNumberModule, DatePicker, ButtonModule, MessageModule, Select, Panel,],
...
export class MusicBandFilterComponent {
  ...
  private validationRules = [{
    ...
    condition: () => this.filter.minParticipants != null && this.filter.maxParticipants != null && this.filter.minParticipants > this.filter.maxParticipants,
    field: 'minParticipants',
    message: 'Мин. не может быть больше Макс.'
  }, {
    condition: () => this.filter.minSingles != null && this.filter.maxSingles != null && this.filter.minSingles > this.filter.maxSingles,
    field: 'minSingles',
    message: 'Мин. не может быть больше Макс.'
  }, {
    condition: () => this.filter.minAlbumsCount != null && this.filter.maxAlbumsCount != null && this.filter.minAlbumsCount > this.filter.maxAlbumsCount,
    field: 'minAlbumsCount',
    message: 'Мин. не может быть больше Макс.'
  }, {
    condition: () => this.filter.minCoordinateX != null && this.filter.maxCoordinateX != null && this.filter.minCoordinateX > this.filter.maxCoordinateX,
    field: 'minCoordinateX',
    message: 'Мин. не может быть больше Макс.'
  }, {
    condition: () => this.filter.minCoordinateY != null && this.filter.maxCoordinateY != null && this.filter.minCoordinateY > this.filter.maxCoordinateY,
    field: 'minCoordinateY',
    message: 'Мин. не может быть больше Макс.'
  }, {
    condition: () => this.filter.establishmentDateAfter && this.filter.establishmentDateBefore && this.filter.establishmentDateAfter > this.filter.establishmentDateBefore,
