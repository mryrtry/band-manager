...
import static org.is.bandmanager.model.MusicGenre.*;
...
class BestBandAwardControllerTest extends AbstractIntegrationTest {
    ...
    void setUp() {
        ...
        Coordinates coordinates = coordinatesRepository.save(Coordinates.builder()
                .x(100)
                .y(50.5f)
                .build());
        ...
        Person frontMan = personRepository.save(Person.builder()
                .name("Test Frontman")
                .eyeColor(Color.BLUE)
        ...
        savedMusicBand = musicBandRepository.save(MusicBand.builder()
                .name("Test Band")
    ...
    void shouldCreateBestBandAwardSuccessfully() {
        ...
        BestBandAwardRequest request = BestBandAwardRequest.builder()
                .musicBandId(savedMusicBand.getId())
                .genre(PROGRESSIVE_ROCK)
                .build();

        // When & Then
        webTestClient.post()
                .uri("/best-band-awards")
    ...
    void shouldReturnBadRequestWhenCreatingAwardWithNullGenre() {
        ...
        webTestClient.post()
                ...
                .jsonPath("$.status").isEqualTo(400)
                .jsonPath("$.message").isEqualTo("Ошибка валидации данных")
                .jsonPath("$.details[0].field").isEqualTo("genre")
                .jsonPath("$.details[0].message").isEqualTo("BestBandAward.MusicGenre не может быть пустым")
                .jsonPath("$.details[0].errorType").isEqualTo("VALIDATION_ERROR");
    }
    ...
    void shouldGetAllBestBandAwards() {
        // Given
        BestBandAward award1 = BestBandAward.builder()
                .band(savedMusicBand)
                .genre(ROCK)
                .build();
        BestBandAward award2 = BestBandAward.builder()
                .band(savedMusicBand)
                .genre(PROGRESSIVE_ROCK)
                .build();
    ...
    void shouldGetBestBandAwardById() {
        // Given
        BestBandAward award = bestBandAwardRepository.save(
                BestBandAward.builder()
                        .band(savedMusicBand)
                        .genre(PUNK_ROCK)
                        .build()
        );
    ...
    void shouldUpdateBestBandAwardSuccessfully() {
        ...
        Coordinates newCoordinates = coordinatesRepository.save(Coordinates.builder()
                .x(200)
                .y(60.5f)
                .build());

        Album newAlbum = albumRepository.save(Album.builder()
                .name("New Album")
                .tracks(12L)
                .sales(2000)
                .build());

        Person newFrontMan = personRepository.save(Person.builder()
                .name("New Frontman")
        ...
        MusicBand newMusicBand = musicBandRepository.save(MusicBand.builder()
                .name("New Band")
                ...
                .albumsCount(3L)
                .establishmentDate(new java.util.Date())
                .frontMan(newFrontMan)
                .creationDate(new java.util.Date())
                .build());

        BestBandAwardRequest update = BestBandAwardRequest.builder()
                .musicBandId(newMusicBand.getId())
                .genre(SOUL)
                .build();
    ...
    void shouldReturnBadRequestWhenUpdatingWithInvalidData() {
        ...
        BestBandAwardRequest invalidUpdate = BestBandAwardRequest.builder()
                .musicBandId(null) // Invalid
                .genre(null) // Invalid
                .build();
    ...
    void shouldCreateAwardsWithDifferentGenres() {
        ...
        for (MusicGenre genre : MusicGenre.values()) {
            ...
            webTestClient.post()
                    ...
                    .expectStatus().isCreated()
                    .expectBody()
                    .jsonPath("$.genre").isEqualTo(genre.toString());
        }
