...
CREATE INDEX idx_best_band_award_created_at ON best_band_award (created_date DESC);
CREATE INDEX idx_best_band_award_genre_created ON best_band_award (genre, created_date DESC);
