...
public class BestBandAwardSpecifications {
    ...
    public static Specification<BestBandAward> withFilter(BestBandAwardFilter filter) {
        return Specification.where(hasGenre(filter.getGenre()))
                .and(hasBandName(filter.getBandName()))
                .and(bandNameContains(filter.getBandNameContains()))
                .and(hasBandId(filter.getBandId()))
                .and(createdAtAfter(filter.getCreatedAtAfter()))
                .and(createdAtBefore(filter.getCreatedAtBefore()));
    }
